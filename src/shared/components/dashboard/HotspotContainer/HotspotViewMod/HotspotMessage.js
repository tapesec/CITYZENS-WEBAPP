...
const HotspotMessage = ({ message }) => (
    <article key={message.id} className="HotspotMessage">
        ...
        <Typography use="body1" tag="p">
            Pour cette nouvelle édition de la kermess de l&apo;école, nous cherchons des volontaires
            pour tenir les stands. Nous avons besoins aussi d&apo;une friteuse et d&apo;une machine à
            barbapapa.Nous avons besoins aussi d&apo;une friteuse et d&apo;une machine à barbapapa.
        </Typography>
        <Typography use="body1" tag="p">
